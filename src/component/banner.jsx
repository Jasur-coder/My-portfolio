		...
		<div className='container'>
			<div className='my-52'>
				<div className='flex items-center gap-10'>
					...
					/>
					<div>
						<h2 className='text-[rgba(0,0,0,0.85)] font-bold text-4xl font-sans'>
							Sayfuddinov Jasurbek
						</h2>
						<p className='my-1.5 text-[rgba(0,0,0,0.5)] font-normal text-3xl font-sans'>
							Web developer
						</p>
				...
				<p className='my-7 text-xl/normal tracking-[0.4px]'>
